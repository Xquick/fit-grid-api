...
<div id="container">
    ...
    <div id="body">
        ...
        <ol>
            <li><a href="<?php echo site_url('api/exercises/'); ?>">Exercises</a></li>
            <li><a href="<?php echo site_url('api/exercises/1/'); ?>">Exercise by ID</a></li>
            <li><a href="<?php echo site_url('api/users/1/history'); ?>">Exercise history of user ID</a></li>
        </ol>
    </div>
</div>
